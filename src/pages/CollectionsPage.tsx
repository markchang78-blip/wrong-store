...
const heroSlides = [
  { image: '/hero-slide-new.png', alt: 'Pets Do Rock Collection 1' },
  { image: '/hero-slide-new.png', alt: 'Pets Do Rock Collection 2' },
  { image: '/hero-slide-new.png', alt: 'Pets Do Rock Collection 3' },
];
...
export default function CollectionsPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      {/* ====== Hero Section — Full bleed image, no frame ====== */}
      ...
      {/* ====== Title Section — matches The Unlikely Entertainment format ====== */}
            ...
            {collections.map((col, i) => (
              <a key={i} href="#/news" className="col-card opacity-0 relative h-[300px] md:h-[350px] lg:h-[450px] overflow-hidden group">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                  ...
                  <span className="inline-flex items-center gap-1 text-xs uppercase tracking-[0.05em] font-medium text-white relative">Shop collection <ArrowRight size={14} /><span className="absolute bottom-0 left-0 w-full h-px bg-white scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300" /></span>
                </div>
              </a>
            ))}
          </div>
